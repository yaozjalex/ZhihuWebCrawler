...
class UpdateQuestions:
    ...
    def run(self):
        ...
        sql = "SELECT LINK_ID from QUESTION WHERE LAST_VISIT < %s AND ADD_TIME > %s ORDER BY LAST_VISIT"
        ...
        self.cursor.execute("DELETE FROM QUESTION WHERE FOCUS < 2 AND ANSWER = 0")
        self.db.close()
...
class Question(object):
    def __init__(self):
        self.question_spider = UpdateQuestions()
